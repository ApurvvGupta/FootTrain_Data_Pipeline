% Main script for A6Left Validated Gait Events
% Calculates relevant gait features

clc; clear; close all;
cycles = readtable("C:\FPA_DP\Ritam_Feedback_CA_Left_TO_Cycles.xlsx");
peaks  = readtable("C:\FPA_DP\Ritam_Feedback_CA_Left_Peak_Detection.xlsx");
hs_tbl = readtable("C:\FPA_DP\Ritam_Feedback_CA_Left_Detected_HS.xlsx");
...
T_final = array2table(merge_table, ...
    ...
    'Valid'});
writetable(T_final, ...
    'Ritam_Feedback_CA_Left_Validated_Gait_Events.xlsx');
